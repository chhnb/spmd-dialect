...
CUDA = {
    ...
    "C2": ("jacobi3d_bench",  [("64 100 10","64"),("256 100 10","256"),("512 50 5","512")]),
    ...
    "C12":("maccormack3d_bench",[("64 100 10","64"),("128 100 10","128"),("256 50 5","256")]),
    "C13":("lulesh_fusion_a100",[("32 500","N=32"),("64 500","N=64"),("128 50","N=128")]),
    "C14":("pic1d_bench",     [("4096 256 100 10","4096p"),("16384 1024 100 10","16384p")]),
    "C15":("cg_fusion_a100",  [("64 200","N=64"),("256 200","N=256"),("1024 50","N=1024")]),
    "C16":("stable_fluids_bench",[("256 5 10","256"),("1024 5 10","1024")]),
    "C17":("conv3d_bench",    [("128 1 10","128"),("256 1 10","256"),("512 1 5","512")]),
    "C18":("doitgen_bench",   [("128 1 10","128"),("256 1 10","256"),("512 1 5","512")]),
    "C19":("lu_bench",        [("512 10","512"),("1024 10","1024")]),
    "C20":("adi_bench",       [("256 3 10","256"),("512 3 10","512"),("2048 3 5","2048")]),
    "C21":("gramschmidt_bench",[("128 10","128"),("256 10","256"),("512 5","512")]),
}
...
TAICHI = {
    ...
    "C2": (".","jacobi3d_taichi","run(N={sz},steps={st},backend='cuda')",[(64,100),(256,100),(512,50)]),
    ...
    "C12":("F3_maccormack_3d","maccormack_taichi","run(N={sz},steps={st},backend='cuda')",[(64,100),(128,100),(256,50)]),
    "C13":(".","lulesh_taichi","run(N={sz},steps={st},backend='cuda')",[(32,10),(64,10),(128,10)]),
    "C14":("C2_pic","pic_taichi","run(n_particles={sz},n_grid={g},steps={st},backend='cuda')",[(4096,256,100),(16384,1024,100)]),
    "C15":(".","cg_taichi","run(N={sz},steps={st},backend='cuda')",[(64,100),(256,100),(1024,50)]),
    "C16":("D2_stable_fluids","fluid_taichi","run(N={sz},steps={st},backend='cuda')",[(256,5),(1024,5)]),
    "C17":(".","conv3d_taichi","run(N={sz},steps={st},backend='cuda')",[(128,1),(256,1),(512,1)]),
    "C18":(".","doitgen_taichi","run(N={sz},steps={st},backend='cuda')",[(128,1),(256,1),(512,1)]),
    "C19":(".","lu_taichi","run(N={sz},steps={st},backend='cuda')",[(512,1),(1024,1)]),
    "C20":(".","adi_taichi","run(N={sz},steps={st},backend='cuda')",[(256,3),(512,3),(2048,3)]),
    "C21":(".","gramschmidt_taichi","run(N={sz},steps={st},backend='cuda')",[(128,1),(256,1),(512,1)]),
}
