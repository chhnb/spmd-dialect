#!/usr/bin/env python3
"""Benchmark runner for 2D Wave Equation."""
...
FRAMEWORKS = {
    "numpy":       ("wave_numpy",   "cpu",  "NumPy"),
    "taichi_cpu":  ("wave_taichi",  "cpu",  "Taichi"),
...
def main():
    ...
    for fw in fw_keys:
        ...
        for N in args.sizes:
            ...
            r = BenchmarkResult("wave_2d", dn, be, f"{N}x{N}", args.warmup, args.repeat, times)
