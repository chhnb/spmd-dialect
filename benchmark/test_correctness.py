...
TILELANG_IMPLS = [
    ...
    ("C8", "F1_hydro_shallow_water", "hydro_tilelang", "run_real(steps=100,backend='cuda',mesh='default')"),
    ("C9", "F2_hydro_refactored", "hydro_refactored_tilelang", "run(steps=100,backend='cuda',mesh='default')"),
]
