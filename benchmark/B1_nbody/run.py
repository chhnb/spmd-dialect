#!/usr/bin/env python3
"""Benchmark runner for N-body (direct all-pairs)."""
...
FRAMEWORKS = {
    "numpy":       ("nbody_numpy",   "cpu",  "NumPy"),
    "taichi_cpu":  ("nbody_taichi",  "cpu",  "Taichi"),
    "taichi_cuda": ("nbody_taichi",  "cuda", "Taichi"),
    "warp_cuda":   ("nbody_warp",    "cuda", "Warp"),
}
...
def main():
    ...
    for fw in fw_keys:
        ...
        for N in args.sizes:
            ...
            r = BenchmarkResult("nbody_direct", dn, be, f"{N}", args.warmup, args.repeat, times)
