set(Kokkos_DEVICES OPENMP;SERIAL;CUDA)
set(Kokkos_OPTIONS DEPRECATED_CODE_5;DEPRECATION_WARNINGS;IMPL_REF_COUNT_BRANCH_UNLIKELY;IMPL_MDSPAN;COMPLEX_ALIGN;LIBDL)
set(Kokkos_TPLS CUDA)
set(Kokkos_ARCH HOPPER90)
set(Kokkos_CXX_COMPILER "/home/scratch.huanhuanc_gpu/spmd/kokkos/bin/nvcc_wrapper")
...
if(Kokkos_ENABLE_CUDA)
  set(Kokkos_CUDA_ARCHITECTURES 90)
endif()
...
if(Kokkos_ENABLE_HIP)
  ...
  foreach(arch IN LISTS GPU_TARGETS)
    if(NOT (arch STREQUAL ))
      ...
      message(
        ${MESSAGE_TYPE}
        "AMD GPU architectures given via GPU_TARGETS=\"${GPU_TARGETS}\" are not compatible with the architecture enabled in Kokkos which is . Kokkos allows only one device architecture to be active. To resolve this, configure with -DGPU_TARGETS=\"\" to prevent it from being set implicitly by find_package calls."
      )
      break()
    endif()
  endforeach()
...
function(kokkos_compilation)
  ...
  set(_HINTS "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../../.." "/usr/local")
