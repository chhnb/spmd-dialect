#!/usr/bin/env python3
"""Benchmark runner for cloth spring-mass."""
...
FRAMEWORKS = {
    "taichi_cuda": ("cloth_taichi", "cuda", "Taichi"),
    "taichi_cpu":  ("cloth_taichi", "cpu",  "Taichi"),
}
...
def main():
    ...
    for fw in fw_keys:
        ...
        for n in args.sizes:
            ...
            r = BenchmarkResult("cloth", dn, be, f"{n}x{n}", args.warmup, args.repeat, times)
            print(f"  {r.summary()}")
            results.append(r)
